...
CREATE TABLE Produto(
    ...
    CONSTRAINT fk_Fornecedor FOREIGN KEY (fkFornecedorProduto) REFERENCES fornecedor(idFornecedor) ON DELETE RESTRICT 
) ENGINE = INNODB;
...
CREATE TABLE PedidoItens(
    ...
    CONSTRAINT fk_PedidoItem_Pedido FOREIGN KEY (fkPedido) REFERENCES pedido(idPedido) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT fk_PedidoItem_Produto FOREIGN KEY (fkProduto) REFERENCES produto(idProduto) ON DELETE RESTRICT ON UPDATE RESTRICT
